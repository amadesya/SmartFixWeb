                    ...
                    <div className="bg-white dark:bg-smartfix-dark p-6 rounded-lg w-full max-w-md shadow-xl text-gray-900 dark:text-white">
                        ...
                        <div className="max-h-48 overflow-y-auto border border-gray-300 dark:border-smartfix-medium p-4 rounded-md bg-gray-50 dark:bg-gray-800 text-sm text-gray-700 dark:text-gray-300 space-y-4">
                            ...
                            <div className="space-y-1">
                                ...
                                <p>1.1. Настоящее Пользовательское соглашение (далее — «Соглашение») регламентирует отношения между администрацией сервиса [Название вашего приложения/сервиса] (далее — «Администрация») и физическим лицом, использующим данный сервис (далее — «Пользователь»).</p>
                            ...
                            <div className="space-y-1">
                                ...
                                <p>2.1. Администрация предоставляет Пользователю неисключительное, непередаваемое право использования сервиса [Название сервиса] в личных, некоммерческих целях (если иное не предусмотрено отдельными тарифами).</p>
